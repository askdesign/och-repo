...
function outreach_load_scripts() {
	...
	wp_enqueue_style( 'google-fonts', '//fonts.googleapis.com/css?family=Lora:400,400i,700,700i', array(), CHILD_THEME_VERSION );
...
function och_custom_footer() { ?>
	...
	<footer class="site-footer" role="contentinfo" itemscope="itemscope" itemtype="https://schema.org/WPFooter"><div class="wrap">Copyright &copy; One Can Help <?php if(date('Y') != 2015) {echo '2015 to ';}; echo date('Y'); ?> | All Rights Reserved | Site maintenance by <a href="https://www.askdesign.biz" target="_blank">ASK Design</a> | Website by <a href="https://www.herwitzassociates.com/" target="_blank">Herwitz Associates</a> and <a href="https://insightdezign.com" target="_blank">Insight Dezign</a><br /><?php dynamic_sidebar( 'copyright-footer' ); ?></div></footer>
